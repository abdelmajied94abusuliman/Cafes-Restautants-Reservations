...
<div class="container pt-5 px-4 mt-3 d-flex">
    <div class="row">
        <div class="col-sm-6 mt-5" >
            <img class="img-fluid rounded" src="{{URL::asset("storage/image/$categories->image")}}" alt="..."    />
            </div>
            ...
            <div class="col-sm-6 col-xl-6 border rounded " style="margin-top:5%; padding:15px; width:750px">
                ...
                <div class="bg-secondary p-4" style="background-color: #fff !important; ">
                    ...
                    <form action="{{route('goToPartTwo')}}" method="POST">
                        ...
                        <button type="submit" style="background-color: #fd7e14 !important ;color:#fff" class="btn">Choose Date</button>
                    </form>
                </div>
                </div>
