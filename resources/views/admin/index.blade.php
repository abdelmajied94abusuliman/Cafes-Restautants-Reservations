...
<body>
    ...
    <div class="content">
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4" style="background-color: #fff !important; ">
                        ...
                        <div class="ms-3">
                            ...
                            <h6 class="mb-0" style="color:black !important">54</h6>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4" style="background-color: #fff !important; ">
                        ...
                        <div class="ms-3">
                            <p class="mb-2">Total Restaurants</p>
                            <h6 class="mb-0" style="color:black !important">3</h6>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4" style="background-color: #fff !important; ">
                        ...
                        <div class="ms-3">
                            <p class="mb-2">Most Day Reserved</p>
                            <h6 class="mb-0" style="color:black !important">Thursday</h6>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4" style="background-color: #fff !important; ">
                        ...
                        <div class="ms-3">
                            <p class="mb-2">Top Reserved In Day</p>
                            <h6 class="mb-0" style="color:black !important">15</h6>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-secondary text-center rounded p-4" style="background-color: #fff !important; ">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <h6 class="mb-0" style="color:black !important">Most Restaurant/Cafe Reserved</h6>
                        </div>
                        <img src="{{URL::asset('/storage/image/makal.jpg')}}" width="320px">
                    </div>
                </div>
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-secondary text-center rounded p-4" style="background-color: #fff !important; ">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <h6 class="mb-0" style="color:black !important">Top Partner</h6>
                        </div>
                        <img src="{{URL::asset('/storage/image/redbull.png')}}" width="320px">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-secondary text-center rounded p-4" style="background-color: #fff !important; ">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h6 class="mb-0" style="color:black !important">Top Customers</h6>
                </div>
                    ...
                    <table class="table text-start align-middle table-bordered table-hover mb-0">
                        <thead>
                            <tr class="text-white">
                                ...
                                <th scope="col" style="color:black !important">Number Of Reservations</th>
                                <th scope="col" style="color:black !important">Most Restaurant/Cafe Reserved</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
